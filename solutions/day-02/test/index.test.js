...
describe('day 2', () => {
	...
	describe('solution 1', () => {
		...
		describe('with test data', () => {
			...
			it('returns the expected result', () => {
				assert.strictEqual(solution1(exampleInput), 15);
			});
		...
		describe('with puzzle input', () => {
			...
			it('returns the expected result', () => {
				assert.strictEqual(solution1(puzzleInput), 12276);
			});
	...
	describe('solution 2', () => {
		...
		describe('with test data', () => {
			...
			it('returns the expected result', () => {
				assert.deepEqual(solution2(exampleInput), 12);
			});
		...
		describe('with puzzle input', () => {
			...
			it('returns the expected result', () => {
				assert.deepEqual(solution2(puzzleInput), 9975);
			});
